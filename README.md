...
本项目是一个使用swiftUI搭建的ai智能体app，它集成了AI智能聊天功能、rag文档查询，文档上传，后端接口采用Spring Boot+langchain4j+ollama+deepseek+qwen3开发

## 主要特性

- **现代化技术栈**：采用swiftUI进行高效开发。
...
- **数据来源**：Python 爬虫
- **AI 服务**：SpringAI + ollma + DeepSeek-R1/Qwen3.5本地模型
